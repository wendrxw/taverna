...
-- at runtime using the environment variable engine_bindir.
...
-- environment variable engine_libdir.
...
-- using the environment variable engine_dynlibdir.
...
-- runtime using the environment variable engine_datadir.
...
-- using the environment variable engine_sysconfdir.
...
bindir     = "/home/wendrxw/.cabal/bin"
libdir     = "/home/wendrxw/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3/engine-0.1.0.0-inplace-engine"
dynlibdir  = "/home/wendrxw/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3"
datadir    = "/home/wendrxw/.cabal/share/x86_64-linux-ghc-9.14.1-c6c3/engine-0.1.0.0"
libexecdir = "/home/wendrxw/.cabal/libexec/x86_64-linux-ghc-9.14.1-c6c3/engine-0.1.0.0"
sysconfdir = "/home/wendrxw/.cabal/etc"

getBinDir     = catchIO (getEnv "engine_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "engine_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "engine_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "engine_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "engine_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "engine_sysconfdir") (\_ -> return sysconfdir)
